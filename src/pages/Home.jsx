    ...
    <div className="mt-24">
      <div className="flex gap-10 flex-wrap justify-center">
        ...
        <div>
          ...
          <div
            className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg flex-col rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10"
            height="100px"
          >
